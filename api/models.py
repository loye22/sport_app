...
class AdditionalOption(models.Model):
    ...
    other_price = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(0)], null=True, blank=True)
    other_description = models.TextField(null=True, blank=True)
    other_image_url = models.URLField(null=True, blank=True)
