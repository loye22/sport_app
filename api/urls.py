...
from .views import    UserSearchView ,DeletePostAPIView ,UpdatePostAPIView ,PostDetailAPIView , GetPostParticipantsView , GetSavedItemsView , CheckEmailExistsView ,SaveRepostView ,SavePostView , IncreaseAllViewsAPIView, CreateNewCategoryView ,AddReviewView ,GetUserAverageReviewView ,GetUserAbsenceFlagView ,KickUserFromEventView ,CreateNoShowView ,GetUserEventProfileByIDView ,GetUserEventsByIDView ,GetUserPostsAndRepostsByIDView , GetUserInfoTabStatsByIDView ,GetUserProfileByIDView , PasswordResetRequestView , MarkNotificationsReadView, NotificationListView ,GetFollowersAndFollowingView, GetUserByIDView ,GetCurrentUserIDView ,GetCurrentUsernameView ,SearchAPIView ,AllEventsView , UserCategoryStatsView , UserEventProfile ,UserRepostsView , UserPostsView , UserProfileTapDetailView ,ReportRepostView , LikeRepostCommentView ,AddRepostCommentView, LikeRepostView ,RepostCommentListView , RepostListView , AddRepostView , AddCommentView , LikeCommentView, CommentListView , CreatePostAPIView , UserProfileListAPIView , CreateVenueAPIView , MyHostedEventsView, CopyEventView ,CheckDateView,UserProfileDetailView , MyEventsView  ,HashtagListCreateView ,  VenueView,PostView , CommentView , ReportPostView , SignupView , LoginView , FollowUserView , LikePostView , EventView , JoinEventView , CancelJoinEventView , CompleteEventView , GetEventView , UpdateEventView , UnfollowUserView  , FileUploadView ,   CategoryListView, CompletedParticipatedEventsView, ProfileBasicInfoView, ProfileUpdateView, DeleteProfileView, DeleteRequestView, RelationStatusView, AmITheEventHostView, CreateAdditionalOptionView, GetAdditionalOptionsByEventView, GetRepostUserIdView
...
urlpatterns = [
            ...
            path('events/<uuid:event_id>/', GetEventView.as_view(), name='get-event'),
            path('events/<uuid:event_id>/update/', UpdateEventView.as_view(), name='update-event'),
            ...
            path('complete_event/', CompleteEventView.as_view(), name='complete-event'),
            ...
            path('posts/<uuid:post_id>/participants/', GetPostParticipantsView.as_view(), name='post-participants'),
            path('posts/<uuid:post_id>/update/', UpdatePostAPIView.as_view(), name='post-update'),
            path('posts/<uuid:post_id>/delete/', DeletePostAPIView.as_view(), name='post-delete'),
            path('report_post/', ReportPostView.as_view(), name='report-post'),
            ...
            path('completed_participated_events/', CompletedParticipatedEventsView.as_view(), name='completed-participated-events'),
            ...
            path('get_user_name/', GetCurrentUsernameView.as_view(), name='get-user-name'),
            path('profile_info/', ProfileBasicInfoView.as_view(), name='profile-info'),
            path('profile_update/', ProfileUpdateView.as_view(), name='profile-update'),
            path('profile_delete/', DeleteProfileView.as_view(), name='profile-delete'),
            path('delete_request/', DeleteRequestView.as_view(), name='delete-request'),
            ...
            path('relation_status/', RelationStatusView.as_view(), name='relation-status'),
            path('amitheeventhost/', AmITheEventHostView.as_view(), name='am-i-the-event-host'),
            path('additional-options/create/', CreateAdditionalOptionView.as_view(), name='create-additional-option'),
            path('additional-options/event/<uuid:event_id>/', GetAdditionalOptionsByEventView.as_view(), name='get-additional-options-by-event'),
