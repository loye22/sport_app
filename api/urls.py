...
urlpatterns = [
            ...
            path('cancel_event/', CancelEventView.as_view(), name='cancel-event'),
            ...
            path('all_events_that_is_mine/', AllEventsThatIsMineView.as_view(), name='all-events-that-is-mine'),
            ...
            path('update_score/', UpdateEventScoreView.as_view(), name='update-score'),
